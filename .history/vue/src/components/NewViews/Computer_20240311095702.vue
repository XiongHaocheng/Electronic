  ...
  <el-row :gutter="5">
    ...
    <el-col :span="6">
      <el-card :body-style="{ padding: '0px' }" shadow="hover">
       <img
         src="https://p4.lefile.cn/product/adminweb/2024/02/21/9Ef6jV4rnzEWlBRJHn4fPlWZ4-1144.jpg"
         class="computer"
       />
       <div style="padding: 14px">
         <p>联想(Lenovo)拯救者Y9000P 2024 16英寸电竞游戏本笔记本电脑</p>
         <p>第14代智能英特尔®酷睿™ i9-14900HX/Windows 11 家庭中文版/16英寸/32G（16X2）/1T SSD/RTX™ 4060 8G独显/碳晶灰</p>
         <p>专业超竞屏       2560x1600分辨率        240Hz高刷新率 100%DCI-P3色域(典型值) 500尼特高亮度(典型值) </p>
         <p>GeForce RTX 40系列笔记本电脑GPU,本地AI算力至高可达686 TOPS*。搭载专用的AI Tensor Core,可为游戏、创作、 日常工作等领域的AI提供强大性能和革新功能。</p>
    ...
    <el-col :span="6">
      <el-row>
         <el-col :span="24">
          ...
          <img
            src="https://p1.lefile.cn/product/adminweb/2024/02/19/QykugVicXO9d8m9wQapnNGbTE-7763.jpg"
            class="computer"
          />
          <div style="padding: 14px"  class="text-container">
            ...
            <div class="bottom">
                ...
                <el-button text class="button" @click="Purchase(['马良铅笔', 1])">购买</el-button>
            </div>
          </div>
        </el-card>        
        </el-col>
...
<el-row>
         <el-col :span="24">
          <el-card :body-style="{ padding: '0px' }">
          <img
            src="https://static.asus.com.cn/store/album/images/R1D4SIQKJPQNBZ/09235256534851.jpg"
            class="computer"
          />
          <div style="padding: 14px"  class="text-container">
            ...
            <div class="bottom">
              ...
              <el-button text class="button" @click="Purchase(['马良铅笔', 2])">购买</el-button>
            </div>
          </div>
        </el-card>
        </el-col>
    ...
    <el-col :span="6">
      <el-row>
         <el-col :span="24">
          <el-card :body-style="{ padding: '0px' }">
          <img
            src="https://p3.lefile.cn/product/adminweb/2024/02/19/LlRjWOujfuVMHa8lKsUOCKBTT-7902.jpg"
            class="computer"
          />
          <div style="padding: 14px"  class="text-container">
            ...
            <div class="bottom">
              ...
              <el-button text class="button" @click="Purchase(['马良铅笔', 3])">购买</el-button>
            </div>
          </div>
        </el-card>
        </el-col>
    ...
    <!-- 第二行的内容放在这里 -->
      ...
      <el-row>
         <el-col :span="24">
          <el-card :body-style="{ padding: '0px' }">
          <img
            src="https://static.asus.com.cn/store/album/images/YQ4QD5LDSPQHY9/17375955985510.jpg"
            class="computer"
          />
          <div style="padding: 14px"  class="text-container">
            ...
            <div class="bottom">
              ...
              <el-button text class="button" @click="Purchase(['马良铅笔', 4])">购买</el-button>
            </div>
          </div>
        </el-card>
        </el-col>
    ...
    <el-col :span="6">
      <el-row>
         <el-col :span="24">
          <el-card :body-style="{ padding: '0px' }">
          <img
            src="https://p1.lefile.cn/product/adminweb/2024/02/19/CjMVCZRjep9kr7lFUqwbgTecJ-9529.jpg"
            class="computer"
          />
          <div style="padding: 14px"  class="text-container">
           <p>联想(Lenovo)小新16 2024款AI高能轻薄笔记本电脑 霜雪银</p>
            <div class="bottom">
              ...
              <el-button text class="button" @click="Purchase(['马良铅笔', 5])">购买</el-button>
            </div>
          </div>
        </el-card>        
        </el-col>
    ...
    <!-- 第二行的内容放在这里 -->
      ...
      <el-row>
         <el-col :span="24">
          <el-card :body-style="{ padding: '0px' }">
          <img
            src="https://static.asus.com.cn/store/album/images/RUHR395SI6ZCHJ/17191955554997.jpg"
            class="computer"
          />
          <div style="padding: 14px"  class="text-container">
           <p>ROG幻16 Air酷睿Ultra 9 16英寸设计师游戏笔记本电脑  (U9-185H 32G 1T RTX4060 2.5K 240Hz OLED)铂月白</p>
            <div class="bottom">
              ...
              <el-button text class="button" @click="Purchase(['马良铅笔', 6])">购买</el-button>
            </div>
          </div>
        </el-card>
        </el-col>
        ...
        <el-card :body-style="{ padding: '0px' }">
          ...
          <div style="padding: 14px"  class="text-container">
            ...
            <div class="bottom">
              ...
              <el-button text class="button" @click="Purchase(['马良铅笔', 7])">购买</el-button>
            </div>
          </div>
        </el-card>
      </el-col>
        ...
        <el-card :body-style="{ padding: '0px' }">
          ...
          <div style="padding: 14px">
            ...
            <div class="bottom">
              ...
              <el-button text class="button" @click="Purchase(['马良铅笔', 8])">购买</el-button>
            </div>
          </div>
        </el-card>
      </el-col>
        ...
        <el-card :body-style="{ padding: '0px' }">
          ...
          <div style="padding: 14px">
            ...
            <div class="bottom">
              ...
              <el-button text class="button" @click="Purchase(['马良铅笔', 9])">购买</el-button>
            </div>
          </div>
        </el-card>
      </el-col>
          ...
          <div style="padding: 14px">
           <p>天选5 Pro 24核酷睿i9 16英寸电竞游戏本 笔记本电脑  (i9-13980HX 16G 1T RTX4060 2.5K高亮高刷)灰</p>
            <div class="bottom">
              ...
              <el-button text class="button" @click="Purchase(['马良铅笔', 10])">购买</el-button>
            </div>
          </div>
        </el-card>
      </el-col>
...
const dataToSend = [newList];

console.log(newList)
console.log(value[0])
axios.post('http://localhost:9090/order/commit', dataToSend)
 .then(response =>{
 })
 axios.post('http://localhost:9090/order/commitsub', value[0])
 .then(response =>{
 })
  }
  </script>
