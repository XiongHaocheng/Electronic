...
<div class="card-container">
    <div class="card">
      <img src="https://p4.lefile.cn/product/adminweb/2023/10/22/5ZHB5PVs31Z0KdyX6h9TOOesn-4858.jpg" style="width: 200px;">
        <div class="text">
            <p style="font-size: 10px;display: flex;justify-content: center;">First Line of Text</p>
...
.card {
    width: 350px; /* Adjust the width of each card */
    height: 380px; /* Adjust the height of each card */
