      ...
      <el-card :body-style="{ padding: '0px' }" shadow="hover">
       ...
       <div style="padding: 14px">
         ...
         <div class="bottom">
           ...
           <el-button  text class="button" @click="Purchase(['水桶', 0])">购买</el-button>
         </div>
       </div>
     </el-card>
    </el-col>
         ...
         <el-col :span="24">
          ...
          <div style="padding: 14px"  class="text-container">
            ...
            <div class="bottom">
              ...
              <el-button text class="button" @click="Purchase(['水桶', 2])">购买</el-button>
            </div>
          </div>
        </el-card>
        </el-col>
         ...
         <el-col :span="24">
          ...
          <div style="padding: 14px"  class="text-container">
            ...
            <div class="bottom">
              ...
              <el-button text class="button" @click="Purchase(['水桶', 3])">购买</el-button>
            </div>
          </div>
        </el-card>
        </el-col>
         ...
         <el-col :span="24">
          ...
          <div style="padding: 14px"  class="text-container">
            ...
            <div class="bottom">
              ...
              <el-button text class="button" @click="Purchase(['水桶', 4])">购买</el-button>
            </div>
          </div>
        </el-card>
        </el-col>
          ...
          <div style="padding: 14px"  class="text-container">
           <p>联想(Lenovo)小新16 2024款AI高能轻薄笔记本电脑 霜雪银</p>
            <div class="bottom">
              ...
              <el-button text class="button" @click="Purchase(['水桶', 5])">购买</el-button>
            </div>
          </div>
        </el-card>        
        </el-col>
          ...
          <div style="padding: 14px"  class="text-container">
           <p>ROG幻16 Air酷睿Ultra 9 16英寸设计师游戏笔记本电脑  (U9-185H 32G 1T RTX4060 2.5K 240Hz OLED)铂月白</p>
            <div class="bottom">
              ...
              <el-button text class="button" @click="Purchase(['水桶', 6])">购买</el-button>
            </div>
          </div>
        </el-card>
        </el-col>
        ...
        <el-card :body-style="{ padding: '0px' }">
          ...
          <div style="padding: 14px"  class="text-container">
            ...
            <div class="bottom">
              ...
              <el-button text class="button" @click="Purchase(['水桶', 7])">购买</el-button>
            </div>
          </div>
        </el-card>
      </el-col>
        ...
        <el-card :body-style="{ padding: '0px' }">
          ...
          <div style="padding: 14px">
            ...
            <div class="bottom">
              ...
              <el-button text class="button" @click="Purchase(['水桶', 8])">购买</el-button>
            </div>
          </div>
        </el-card>
      </el-col>
        ...
        <el-card :body-style="{ padding: '0px' }">
          ...
          <div style="padding: 14px">
            ...
            <div class="bottom">
              ...
              <el-button text class="button" @click="Purchase(['水桶', 9])">购买</el-button>
            </div>
          </div>
        </el-card>
      </el-col>
          ...
          <div style="padding: 14px">
           <p>天选5 Pro 24核酷睿i9 16英寸电竞游戏本 笔记本电脑  (i9-13980HX 16G 1T RTX4060 2.5K高亮高刷)灰</p>
            <div class="bottom">
              ...
              <el-button text class="button" @click="Purchase(['水桶', 10])">购买</el-button>
            </div>
          </div>
        </el-card>
      </el-col>
