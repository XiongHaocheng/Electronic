...
<div class="image-container">
      <div class="horizontal-images">
        ...
        <div class="vertical-images">
          ...
          <img src="https://p2.lefile.cn/fes/cms/2024/01/22/mxdywrcke9tqxq7gcv4zqqg0w9sw0z400659.jpg" style="margin-top: 20px;transition: transform 0.3s ease; /* Add transition effect */"  @mouseover="zoomIn" @mouseleave="zoomOut">
        </div>
      </div>
    </div>
