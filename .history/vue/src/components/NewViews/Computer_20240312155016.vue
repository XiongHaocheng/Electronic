    ...
    <div class="card">
      ...
      <div style="display: flex;">
                <div class="button1-style">
                  <p style="font-size: 1px;width: 100px;margin-left: -20px;margin-top: -8px;color: #f26e6e;">外观定制
                  </p>
                </div>
                <div class="button2-style">
                  <p style="font-size: 1px;width: 100px;margin-left: -30px;margin-top: -8px;">12期</p>
                </div>
              </div>
