          ...
          <div class="hot-card" style="width: 20%;">
            <img
              ...
              <div style="text-align:center;margin-left: 20px;">
                ...
                <div style="display: flex;">
                  <div class="button1">
                    <p style="font-size: 1px;width: 200px;margin-left: -780px;margin-top: -8px;color: #f26e6e;">限时直降600元
                    </p>
                  </div>
                  <div class="button2">
                    <p style="font-size: 1px;width: 200px;margin-left: -9px;margin-top: -8px;">3期0分期利息</p>
                  </div>
                </div>
                <div style="display: flex;align-items: center;margin-top: 20px;">
                  <div class="price">
