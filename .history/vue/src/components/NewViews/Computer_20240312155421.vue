  ...
  <div class="card-container">
    <div class="card">
      <img src="https://p4.lefile.cn/product/adminweb/2023/10/22/5ZHB5PVs31Z0KdyX6h9TOOesn-4858.jpg"
        style="width: 200px;">
      <div style="display: flex;ac">
        <p style="font-size: 10px;display: flex;justify-content: center;">联想平板小新Pad 2024 11英寸 学习办公娱乐影音平板电脑</p>
        <p style="font-size: 5px;display: flex;justify-content: center;">Qualcomm Snapdragon 685/8核/Android系统/11英寸/</p>
      </div>
