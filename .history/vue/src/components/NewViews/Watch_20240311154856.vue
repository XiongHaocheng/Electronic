    ...
    <div style="margin: 0 150px;">
      ...
      <div style="text-align: center;">
        ...
        <div style="display: flex; justify-content: space-between;margin-bottom: 50px;">
          ...
          <div class="hot-card" style="width: 20%;">
            <img
              ...
              style="width: 150px;">
              <div style="justify-content: center;margin-left: 20px;margin-top: -20px;">
                <p style="font-size: 15px; width: 180px;">MateBook 14s</p>
                <p style="font-size: 12px;opacity: 0.6;">32GB大内存 | 13代酷睿处理器</p>
                <div style="display: flex;">
                  <div class="button1">
                    <p style="font-size: 1px;width: 200px;margin-left: -70px;margin-top: -8px;color: #f26e6e;">限时直降600元
                    </p>
                  </div>
                  <div class="button3">
                    <p style="font-size: 1px;width: 200px;margin-left: -80px;margin-top: -8px;">3期0分期利息</p>
                  </div>
                </div>
