...
<div class="image-container">
      <div class="horizontal-images">
        <img src="https://p2.lefile.cn/fes/cms/2024/01/22/syoyls24jgu21mt6az2zqc03ie7xbn487696.jpg" style="transition: transform 0.3s ease;"  @mouseover="zoomIn" @mouseleave="zoomOut" >
        <div class="vertical-images">
          <img src="https://p4.lefile.cn/fes/cms/2024/01/22/n8va2woj75791edaqzlvs574gsnu84873223.jpg" style="transition: transform 0.3s ease;" @mouseover="zoomIn" @mouseleave="zoomOut">
          <img src="https://p2.lefile.cn/fes/cms/2024/01/22/mxdywrcke9tqxq7gcv4zqqg0w9sw0z400659.jpg" style="margin-top: 20px;transition: transform 0.3s ease;"  @mouseover="zoomIn" @mouseleave="zoomOut">
        </div>
      </div>
    </div>
...
.new-container {
  ...
  align-items: center;
  height: 20vh; /* Adjust according to your layout */
}
...
.circle {
  ...
  opacity: 0.8; /* Set opacity for text */
  box-sizing: border-box; /* optional: include border in width and height */
}
...
.image-container {
  margin-top: 20px; /* Adjust spacing between text and images */
  display: flex;
  justify-content: center;
  align-items: center;
}
