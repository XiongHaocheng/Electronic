...
>
  ...
  <el-affix position="bottom" :offset="10">
    ...
    <el-col :span="2">
      <el-button type="danger" style="width: 130px;height: 60px;margin-top: -9px;margin-bottom: -9px;" @click="cartPurchase(index)">购买</el-button>
    </el-col>
  </el-row>
...
const cartPurchase = async (index-1: number) => {
  const purchaseRow = tableData[index-1]; // 获取要购买的行数据
