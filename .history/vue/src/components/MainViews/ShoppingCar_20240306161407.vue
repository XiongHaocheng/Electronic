...
>
  ...
  <el-affix position="bottom" :offset="10">
    ...
    <el-col :span="2">
      <el-button type="danger" style="width: 130px;height: 60px;margin-top: -9px;margin-bottom: -9px;" @click.prevent="cartPurchase(scope.row)">购买</el-button>
    </el-col>
  </el-row>
...
const cartPurchase = async (purchaseRow: User) => {
  try {
    // 发送购买请求至后端
