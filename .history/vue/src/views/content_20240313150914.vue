...
const gallery = reactive({
      images: [],
      selectedImage: 'https://res2.vmallres.com/pimages/uomcdn/CN/pms/202311/gbom/6941487293926/group/428_428_C59DD8CA571F5BC89EC0555A3CEC9BA7.png' // 初始时选中的图片，可以根据需要设置
    });
const price = ref(0)
const Nprice = ref(0)
const name = ref('')
...
onMounted(() => {
  ...
  axios.post("http://localhost:9090/order/picture", parsedData)
    .then(res => {
      ...
      gallery.selectedImage = urlArray[0]
    })
});
//购买
const Purchase = () => {
