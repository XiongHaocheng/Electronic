<template>
  <div class="container">
    ...
    <div class="top-section">
      <div style="margin-left: 18%;height: 60%;">
        <img src="../../picture/QQ图片20240309164723.png" alt="First Image" style="margin:10px;width:10px">
    ...
    <div class="middle-section">
      ...
      <div class="login-container">
        <el-form ref="form" :model="form" :rules="rules" class="login-page">
          <h2 class="title" style="margin-bottom: 10px;text-align: center">登录</h2>
...
.middle-section:before {
  ...
  width: 100%;
  height: 100%;
  background-image: url('https://img0.baidu.com/it/u=127591940,3690931432&fm=253&fmt=auto&app=120&f=JPEG?w=1532&h=600'); 
