<template>
  ...
  <el-row>
    ...
    <div>
      <el-breadcrumb :separator-icon="ArrowRight">
        <el-breadcrumb-item :to="{ path: '/' }" @click="refreshPage">首页</el-breadcrumb-item>
  ...
  <el-row>
      ...
      <div class="image-gallery">
        ...
        <div class="thumbnails">
          <div class="thumbnail" v-for="(image, index) in images" :key="index"
            :class="{ 'selected': image === selectedImage }" @mouseover="selectImage(image, index)">
            <img :src="image" alt="" />
          </div>
        </div>
      </div>
    ...
    <el-col :span=11>
      ...
      <div style="margin-top: 20px;">
        <el-link :underline="false" @click="centerDialogVisible = true"
          style="color: red;">【京彩绿色消费券】京彩绿色消费，领券至高省0元！马上参与＞</el-link>
      </div>
        ...
        <div>
          <el-row>
            ...
            <el-col :span="5" :offset="10">
              <el-card
                style="width: 40px; height: 40px; background-color: rgb(240,240,240); cursor: pointer;margin-top: -13px;margin-left: 100px;"
                shadow="hover" @click="downPrice = true">
                <div
                  style="font-size: 15px; margin-left: -15px; margin-top: -20px; margin-right: -15px; color: #5b96df;">
                  降价</div>
      ...
      <div>
        <el-row>
          <el-col :span="3">
            <div class="label" style="margin-top: 5px;">配送至</div>
          </el-col>
        ...
        <el-row>
          <el-col :span="3">
            <div class="label" style="margin-top: 5px;">操作系统</div>
          </el-col>
          <el-col :span="7" :offset="1">
            <el-button :size="'small'" class="Ebutton" :class="{ 'is-active': isActive }" @click="toggleActive">
              Windows 11 家庭中文版
            </el-button>
          </el-col>
        </el-row>
        ...
        <el-row>
          <el-col :span="3">
            <div class="label" style="margin-top: 5px;">处理器</div>
          </el-col>
          <el-col :span="9" :offset="1">
            <el-button size="small" class="Ebutton" :class="{ 'active': selected === 'i9-14900HX/碳晶灰' }"
              @click="selectCPU('i9-14900HX/碳晶灰')">
              i9-14900HX/碳晶灰
            </el-button>
          </el-col>
          <el-col :span="7">
            <el-button size="small" class="Ebutton" :class="{ 'active': selected === 'i9-14900HX/冰魄白' }"
        ...
        <el-row>
          ...
          <el-col :span="9" :offset="1">
            <el-button size="small" class="Ebutton" :class="{ 'active': selected === '【至尊版】i9-14900HX/碳晶黑' }"
        ...
        <el-row>
          <el-col :span="3">
            <div class="label" style="margin-top: 5px;">存储</div>
          </el-col>
          <el-col :span="9" :offset="1">
            <el-button size="small" class="Ebutton" :class="{ 'active': selectedRam === '【官方标配】16G/1T SSD' }"
              @click="selectRam('【官方标配】16G/1T SSD')">
              【官方标配】16G/1T SSD
            </el-button>
          </el-col>
          <el-col :span="9">
            <el-button size="small" class="Ebutton" :class="{ 'active': selectedRam === '【官方定制】16G/2T SSD(1Tx2)' }"
        ...
        <el-row>
          ...
          <el-col :span="9" :offset="1">
            <el-button size="small" class="Ebutton" :class="{ 'active': selectedRam === '【官方定制】32G(16Gx2)/1T SSD' }"
              @click="selectRam('【官方定制】32G(16Gx2)/1T SSD')">
              【官方定制】32G(16Gx2)/1T SSD
            </el-button>
          </el-col>
          <el-col :span="9">
            <el-button size="small" class="Ebutton" :class="{ 'active': selectedRam === '【官方标配】32G（16+16）/1T SSD' }"
        ...
        <el-row>
          <el-col :span="3">
            <div class="label" style="margin-top: 5px;">显卡</div>
          </el-col>
          <el-col :span="9" :offset="1">
            <el-button size="small" class="Ebutton" :class="{ 'active': selectedGPU === 'RTX™ 4060 8GB独显' }"
              @click="selectGPU('RTX™ 4060 8GB独显')">
              RTX™ 4060 8GB独显
            </el-button>
          </el-col>
          <el-col :span="9">
            <el-button size="small" class="Ebutton" :class="{ 'active': selectedGPU === 'RTX™ 4090 16GB独显' }"
        ...
        <el-row>
          ...
          <el-col :span="9" :offset="1">
            <el-button size="small" class="Ebutton" :class="{ 'active': selectedGPU === 'RTX™ 4070 8GB独显' }"
        ...
        <el-row>
          <el-col :span="3">
            <div class="label" style="margin-top: 5px;">选择服务</div>
          </el-col>
          <el-col :span="9" :offset="1">
            <el-button size="small" class="Ebutton" :class="{ 'active': selectedSer === '1年意外保+只换不修+清洁' }"
              @click="selectSer('1年意外保+只换不修+清洁')">
              1年意外保+只换不修+清洁
            </el-button>
          </el-col>
          <el-col :span="9">
            <el-button size="small" class="Ebutton" :class="{ 'active': selectedSer === '1年延保+3次清洁' }"
        ...
        <el-row>
          ...
          <el-col :span="9" :offset="1">
            <el-button size="small" class="Ebutton" :class="{ 'active': selectedSer === '3年整机保修' }"
              @click="selectSer('3年整机保修')">
              3年整机保修
            </el-button>
          </el-col>
          <el-col :span="9">
            <el-button size="small" class="Ebutton" :class="{ 'active': selectedSer === '2年单次意外保' }"
        ...
        width: 120px;background-color: #5b96df;color: white;" @click="addToCart()">加入购物车</el-button>
            <el-button size="large" style="border-radius: 0;
        width: 120px;background-color: #d81e06;color: white;" @click="Purchase()">立刻购买</el-button>
            <div style="font-size: 12px;margin-top: 10px;color: #ccc4c8;"><span><el-icon>
                  <CircleCheck />
                </el-icon>联想自营</span> <span style="margin-left: 20px;"><el-icon>
                  <CircleCheck />
                </el-icon>联想发货&售后</span> <span style="margin-left: 20px;"><el-icon>
                  <CircleCheck />
                </el-icon>14天无忧退换</span></div>
          </el-col>
  ...
  <el-dialog v-model="centerDialogVisible" title="恭喜您！" width="500" center>
    <div style="font-size: 20px;text-align: center;">您获得了<span style="font-weight: bold; color: red;">最高</span>的<span
        style="font-weight: bold; color: red;"> 0 </span>元优惠券！</div>
    <template #footer>
...
const gallery = reactive({
      images: [],
      selectedImage: '' // 初始时选中的图片，可以根据需要设置
    });
const price = ref(0)
const Nprice = ref(0)
const name = ref('')
...
onMounted(() => {
  ...
  axios.post("http://localhost:9090/order/picture", parsedData)
    .then(res => {
      // 提取 url 数据并添加到 images 数组中
      const urlArray = res.data.data.map((item: { url: any; }) => item.url);
      console.log(urlArray);

      // 更新全局的 gallery 对象
      gallery.images = urlArray;
      const normalArray = Array.from(gallery.images);
      console.log(normalArray); // 这里可以查看 gallery 对象是否正确更新
      gallery.images = normalArray;
      console.log(gallery.images); // 这里可以查看 gallery 对象是否正确更新
      // 使用 Array.from() 创建一个新数组，确保数据类型一致
    const newArray = Array.from(normalArray);

// 将新数组赋值给 gallery.images
gallery.images = newArray;

// 确认赋值后，gallery.images 和 normalArray 的数据类型一致
console.log(Array.isArray(gallery.images)); // 输出 true
