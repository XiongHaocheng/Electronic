...
onMounted(() => {
  ...
  axios.post("http://localhost:9090/order/confirm", parsedData).
    ...
    .then(res => {
      ...
      gallery.images.push(res.data['0'].url);
gallery.images.push(res.data.data['1'].url);
gallery.images.push(res.data['2'].url);
gallery.images.push(res.data['3'].url);
gallery.images.push(res.data['4'].url);
    })
    gallery.selectedImage = gallery.images[0];
console.log(gallery);
});
//购买
const Purchase = () => {
