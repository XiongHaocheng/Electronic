  ...
  <el-row>
    ...
    <el-col :span="10" :offset="1">
      <el-button size="large" style="border-radius: 0;
        width: 120px;background-color: #d81e06;color: white;">立刻购买</el-button>
...
onMounted(() => {
  // 使用 useRoute() 钩子来获取路由信息
  const route = useRoute();
  // 从路由参数中获取 id
  const phoneId = route.params.id;

  // 发送 GET 请求，并在获取数据后进行处理
  axios.get(`http://localhost:9090/order/confirm?id=${phoneId}`)
    .then(response => {
...
this.params =this.$route.query.params // 获取从router中传过来的参数
